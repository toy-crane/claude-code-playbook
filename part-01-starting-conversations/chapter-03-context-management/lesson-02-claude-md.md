---
title: "Lesson 02: 프로젝트 규칙, 한 번만 설명하기 | CLAUDE.md"
date: 2026-02-03
tags:
  - learning/courses
  - ai/claude
...
aliases:
  - "CLAUDE.md"
  - "클로드엠디"
description: "매 대화마다 자동 로드되는 CLAUDE.md의 역할과 '모델이 코드에서 찾을 수 없는 것만 넣는' 원칙을 이해한다"
status: published
permalink: cc-lge/claude-md
---
