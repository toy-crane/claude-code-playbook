...
![spec-test-first-task](/docs/completing-projects/spec-driven-development/spec-test-first-task.png)

## Spec Test: 불변 계약

![contract-vs-worklog](/docs/completing-projects/spec-driven-development/contract-vs-worklog.png)
