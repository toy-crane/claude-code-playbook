---
title: '설치와 첫 실행'
description: 'Claude Code를 설치하고, Team 요금제와 모델 선택을 이해한 후, 첫 실행까지 완료합니다'
public: true
---
...
- Anthropic 계정 (Team 요금제 초대 완료, [사전 준비사항](../../prerequisites) 참조)
...
<Callout type="warn" title="사용량 제한에 주의하세요">
...
다음 레슨 보기: [기본 인터페이스 익히기](./basic-interface)
