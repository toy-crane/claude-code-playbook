---
title: '내 시스템을 Claude에 연결하기 | Custom MCP 서버 만들기'
description: >-
...
<Callout type="info" title="결과가 다를 수 있습니다">
...
<Callout type="info" title="왜 stdin/stdout인가?">
...
다음 레슨 보기: [도구 연결 + 사용 설명서](./external-tools-and-skills)
