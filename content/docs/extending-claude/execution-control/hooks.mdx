---
title: 'AI가 코드 고칠 때마다 자동 검증 | Hooks'
description: >-
  VS Code ESLint 플러그인처럼, Claude Code에서도 코드 수정을 자동 검증하는 Hook을 직접 만듭니다. 파일 단위
  lint(PostToolUse)와 테스트 관문(Stop) 두 가지를 실습합니다
public: true
---
...
<Callout type="info" title="더 많은 Hook 이벤트">
