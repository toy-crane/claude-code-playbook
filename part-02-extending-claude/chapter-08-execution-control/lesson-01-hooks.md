...
aliases:
  - "Hooks"
  - "클로드 코드 훅"
description: "VS Code ESLint 플러그인처럼, Claude Code에서도 코드 수정을 자동 검증하는 Hook을 직접 만든다. 파일 단위 lint(PostToolUse)와 테스트 관문(Stop) 두 가지를 실습한다"
status: published
permalink: cc-lge/hooks
---
...
다음 레슨 보기: [[lesson-02-custom-agent]]
