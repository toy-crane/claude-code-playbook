...
tags:
  ...
  - ai/agents
aliases:
  - "External Tools + Skills Synergy"
  - "외부 도구와 Skills 시너지"
  - "Capability vs Procedure"
description: "MCP와 CLI 모두 도구 접근권(Capability)을, Skill은 사용 절차(Procedure)를 담당한다. 이 분리를 이해하고, 외부 도구 + Skill 결합의 실전 워크플로우를 설계한다"
status: draft
permalink: cc-lge/external-tools-and-skills
---
