...
aliases:
  - "The Next Step in Coding Tools | Agentic Coding and Claude Code"
  - "Agentic 코딩 기초"
description: "코딩 도구가 자동완성에서 대화형 편집, Agentic 코딩으로 진화하는 흐름을 이해하고, Claude Code의 핵심 특성(Terminal-native, Agentic, 프로그래밍 가능)을 배운다"
status: published
permalink: cc-lge/agentic-coding
---
...
다음 레슨 보기: [[lesson-01-setup-and-first-run]]
