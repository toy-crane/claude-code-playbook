---
title: "Lesson 01: 규칙을 필요한 곳에만 적용하기 | Rules"
date: 2026-02-23
tags:
  - learning/courses
  - ai/claude
...
aliases:
  - "Claude Code Rules"
  - "클로드 코드 룰"
description: "CLAUDE.md에 모든 규칙을 넣으면 발생하는 주의력 분산 문제를 .claude/rules/의 주제별 파일 분리와 paths 경로 제한으로 해결하는 방법을 배운다"
status: draft
permalink: cc-lge/rules
---
...
다음 레슨 보기: [[lesson-02-custom-commands]]
