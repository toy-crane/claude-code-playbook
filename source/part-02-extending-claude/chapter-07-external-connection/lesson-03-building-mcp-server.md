...
aliases:
  ...
  - "MCP 서버 구현"
  - "Custom MCP 개발"
description: "MCP의 서버/클라이언트 구조를 이해하고, MCP Builder Skill을 사용하여 날씨 API를 감싸는 MCP 서버를 직접 만들어 Claude Code에 연결한다"
status: draft
permalink: cc-lge/building-mcp-server
---
...
다음 레슨 보기: [[lesson-04-external-tools-and-skills]]
