...
aliases:
  - "Task System Basics"
  - "태스크 시스템 기본"
description: "계획이 커서 context가 넘치면 auto-compact가 구조 정보를 유실한다. Task 시스템으로 계획을 JSON 파일에 보존하고, blockedBy/blocks 의존성으로 작업 순서를 관리하는 방법을 배운다"
status: published
permalink: cc-lge/task-basics
---
