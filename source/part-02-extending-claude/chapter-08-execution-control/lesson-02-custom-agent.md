---
title: "Lesson 02: 역할 분담이 아니라 컨텍스트 제어 | Custom Agent"
date: 2026-02-06
tags:
  - learning/courses
  - ai/claude
...
aliases:
  - "Custom Agent"
  - "클로드 코드 커스텀 에이전트"
description: "Subagent의 컨텍스트 격리 원리를 이해하고, .claude/agents/에 테스트 계획 전문 Custom Agent를 직접 만들어 메인 컨텍스트를 보호하는 방법을 배운다"
status: published
permalink: cc-lge/custom-agent
---
...
다음 레슨 보기: [[lesson-03-part-2-wrap-up]]
